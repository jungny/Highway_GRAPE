...
cycle_GRAPE = 3; % GRAPE instance per 5 seconds

Simulation.Setting.InitialRandomSeed = 1;
Simulation.Setting.Iterations = 200; % number of iterations
...
filename = fullfile(Simulation.Setting.SaveFolder, ['reprd_' greedy_status2 '_' Simulation.Setting.Util_type '_' timestamp '.xlsx']);
sheet = 'Results';
...
for Iteration = 1:Simulation.Setting.Iterations
    ...
    for mode_idx = 1:num_modes
        ...
        if Simulation.Setting.RecordVideo
            ...
            videoFilename = fullfile(Simulation.Setting.SaveFolder, ['\simulations\reprd_' greedy_status2 '_' Simulation.Setting.Util_type '_' timestamp '_' Simulation.Setting.NumberOfParticipants]);
        ...
        for Time = 0:Parameter.Physics:Parameter.Sim.Time
            ...
            for i = 1:size(List.Vehicle.Active,1)
                ...
                elseif List.Vehicle.Object{List.Vehicle.Active(i,1)}.ExitState >= 0 && List.Vehicle.Object{List.Vehicle.Active(i,1)}.Location * Parameter.Map.Scale >= List.Vehicle.Object{List.Vehicle.Active(i,1)}.Exit - 5 
                    % record travel time, avg speed
                    spawn_time = List.Vehicle.Object{List.Vehicle.Active(i,1)}.EntryTime;
                    exit_time = Time;
                    travel_time = exit_time - spawn_time;
