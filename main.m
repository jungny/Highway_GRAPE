...
Simulation.Setting.Iterations = 50; % number of iterations
...
% 🔹 엑셀 파일 경로 설정
timestamp = datestr(now, 'HH-MM');  % 현재 시간 가져오기 (시-분-초 형식)
filename = fullfile(Simulation.Setting.SaveFolder, ['md_Greedy_HOS_' timestamp '.xlsx']);
sheet = 'Results';
...
% 🔹 엑셀 파일 경로 설정
timestamp = datestr(now, 'HH-MM');  % 현재 시간 가져오기 (시-분-초 형식)
filename = fullfile(Simulation.Setting.SaveFolder, ['md_Greedy_FOS_' timestamp '.xlsx']);
sheet = 'Results';
...
% 🔹 엑셀 파일 경로 설정
timestamp = datestr(now, 'HH-MM');  % 현재 시간 가져오기 (시-분-초 형식)
filename = fullfile(Simulation.Setting.SaveFolder, ['md_Greedy_OriginalUtility_' timestamp '.xlsx']);
sheet = 'Results';
...
% 🔹 엑셀 파일 경로 설정
timestamp = datestr(now, 'HH-MM');  % 현재 시간 가져오기 (시-분-초 형식)
filename = fullfile(Simulation.Setting.SaveFolder, ['md_GRAPE_GS_' timestamp '.xlsx']);
sheet = 'Results';
...
% 🔹 엑셀 파일 경로 설정
timestamp = datestr(now, 'HH-MM');  % 현재 시간 가져오기 (시-분-초 형식)
filename = fullfile(Simulation.Setting.SaveFolder, ['md_GRAPE_HOS_' timestamp '.xlsx']);
sheet = 'Results';
...
% 🔹 엑셀 파일 경로 설정
timestamp = datestr(now, 'HH-MM');  % 현재 시간 가져오기 (시-분-초 형식)
filename = fullfile(Simulation.Setting.SaveFolder, ['md_GRAPE_FOS_' timestamp '.xlsx']);
sheet = 'Results';
...
% 🔹 엑셀 파일 경로 설정
timestamp = datestr(now, 'HH-MM');  % 현재 시간 가져오기 (시-분-초 형식)
filename = fullfile(Simulation.Setting.SaveFolder, ['md_GRAPE_OriginalUtility_' timestamp '.xlsx']);
sheet = 'Results';
